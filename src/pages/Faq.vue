<template>
    <div class="faq">
        ...
        <section class="header max-mid mx-auto text-center">
            ...
            <SearchField v-model="searchString" placeholder="What do you need help with?" :overrideStyle="searchFieldStyle" class="mb4 pb3"/>
        </section>
            ...
            faqList: [
                {
                    ...
                    answer: 'Eum repellat cupiditate assumenda nemo qui excepturi impedit omnis. Et voluptatem consequatur cupiditate et minima necessitatibus consectetur dignissimos. Voluptas ratione omnis et sed minus. Consectetur earum autem qui architecto iusto illo adipisci id. Modi dolorem sapiente totam cum sapiente. Iste odit nisi dicta.'
                },
                {
                    id: 1,
                    question: 'Lorem ipsum?',
                    answer: 'Search test Eum repellat cupiditate assumenda nemo qui excepturi impedit omnis. Et voluptatem consequatur cupiditate et minima necessitatibus consectetur dignissimos. Voluptas ratione omnis et sed minus. Consectetur earum autem qui architecto iusto illo adipisci id. Modi dolorem sapiente totam cum sapiente. Iste odit nisi dicta.'
                },
                {
                    id: 2,
                    question: 'Lorem ipsum?',
