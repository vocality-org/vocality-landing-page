...
<nav id="side-navigation" class="sidenav show-on-sm">
    <ul class="list-reset flex-column">
        <li>
            <a href="#" class="text-decoration-none block h-100 pl2">Commands</a>
        </li>
        <li>
            <a href="#" class="text-decoration-none block h-100 pl2">FAQ</a>
        </li>
        <li>
            <a href="#" class="text-decoration-none block h-100 pl2">About</a>
        </li>
    </ul>
</nav>
    ...
    <header class="flex py1 px3">
        ...
        <nav class="hide-on-sm">
            <ul class="list-reset flex items-center m0 h-100">
                <li>
                    <a href="pages/commands.html" class="text-decoration-none px3">Commands</a>
                </li>
                <li>
        ...
        <div class="flex justify-center py3">
            <nav>
                <ul class="list-reset flex items-center">
                    <li class="px3">
                        <a href="#" class="text-decoration-none h5">Commands</a>
                    </li>
                    <li class="px3">
                        <a href="#" class="text-decoration-none h5">Donate</a>
                    </li>
                    <li class="px3">
                        <a href="#" class="text-decoration-none h5">Support</a>
                    </li>
                    <li class="px3">
                        <a href="#" class="text-decoration-none h5">FAQ</a>
                    </li>
                    <li class="px3">
                        <a href="#" class="text-decoration-none h5">About</a>
                    </li>
                </ul>
            </nav>
        </div>
